...
module.exports = {
  ...
  "ps3": {
    ...
    "update": function(data) {
      ...
      state['button:Start'] = data[4] >> 7 & 1;
      state['button:halfhalf'] = data[5] >> 1 & 1;
      state['button:half'] = data[4] >> 2 & 1;
      state['button:one'] = data[4] >> 0 & 1;
      state['button:Select'] = data[6] >> 4 & 1;
  ...
  "sb3": {
    ...
    "update": function(data) {
      ...
      state['button:T'] = data[4] >> 4 & 1;
      state['button:O'] = data[4] >> 5 & 1;
      state['button:X'] = data[4] >> 6 & 1;
      state['button:S'] = data[4] >> 7 & 1;
      ...
      state['button:Up'] = data[4] >> 0 & 1;
      state['button:Right'] = data[4] >> 1 & 1;
      state['button:Down'] = data[4] >> 2 & 1;
      state['button:Left'] = data[4] >> 3 & 1;

      state['button:Start'] = data[5] >> 5 & 1;
      // state['button:halfhalf'] = data[5] >> 1 & 1;
      // state['button:half'] = data[4] >> 2 & 1;
      // state['button:one'] = data[4] >> 0 & 1;
      state['button:Select'] = data[5] >> 4 & 1;
  ...
  "ps4": {
    ...
    "update": function(data) {
      ...
      state['button:Up'] = data[5] >> 0 & 1;
      state['button:Right'] = data[5] >> 1 & 1;
      state['button:Down'] = data[5] >> 2 & 1;
      state['button:Left'] = data[5] >> 3 & 1;
